    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_id', models.CharField(blank=True, max_length=14, null=True, unique=True, validators=[clinic.models.validate_national_id])),
                ('name', models.CharField(max_length=50)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('mobile_phone', models.CharField(blank=True, max_length=11, null=True, unique=True, validators=[clinic.models.validate_phone_number])),
